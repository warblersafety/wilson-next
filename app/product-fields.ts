...
export const nonDeviceProductFields = [
  "manufacturer", "lotNumber", "dose", "strength", "frequency", "route", "startDate", "stopped", "stopDate", "doseReduced", "improvedAfterChange", "restarted", "recurred", "medicationType", "indication",
